...
extern NSString *const PFInstallationKeyParseVersion;
extern NSString *const PFInstallationKeyDeviceType;
extern NSString *const PFInstallationKeyInstallationId;
extern NSString *const PFInstallationKeyDeviceToken;
extern NSString *const PFInstallationKeyAppName;
